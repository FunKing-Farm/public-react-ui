                ...
                <div className="max-w-full px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="text-sm text-gray-600 border-l pl-4 ml-4 hidden md:block">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button 
                                ...
                                disabled={!selectedDefinition}
                                className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed text-sm hidden lg:block"
                            >
                                Spawn Grid (3×3)
                            </button>
                            <button 
